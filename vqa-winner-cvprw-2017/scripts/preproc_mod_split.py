...
def process_a(freq_thr=9):
    ...
    ta_0 = json.load(open(ta_path))['annotations']
    va_0 = json.load(open(va_path))['annotations']
    annos_0 = ta_0 + va_0
    annos=[]
...
def process_qa(targets, max_words=14):
    ...
    tq_0 = json.load(open(tq_path))['questions']
    vq_0 = json.load(open(vq_path))['questions']
