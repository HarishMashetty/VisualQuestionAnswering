...
class Model(nn.Module):
    ...
    def __init__(self, vocab_size, wemb_init, hid_dim, num_classes):
        ...
        self.gth_iatt = nn.Linear(2048 + hid_dim + 15 + 14, hid_dim)
        self.gthp_iatt = nn.Linear(2048 + hid_dim + 15 + 14, hid_dim)
        self.gth_q = nn.Linear(hid_dim + 15 + 14, hid_dim)
        self.gthp_q = nn.Linear(hid_dim + 15 + 14, hid_dim)
    ...
    def forward(self, image, question):
        ...
        # image attention
        qenc_reshape = qenc.repeat(1, 36).view(-1, 36, self.hid_dim + 15 + 14)    # (batch, 36, hid_dim)
